...
<body>
	<?php if(logado()): ?>
		<?php if(!selecionado()){
		 	header("location: php/selecionar.php?x=mu&tipo=null&setor=null&relevancia=null&status=null");
		} ?>
						...
						<div class="container main col-9 col row branco rad-1">
							<div>
								<div class="row col-12 col">
									<h2 class="f20 bottom col">Minhas Manifestações</h2>
									<?php if(ouvidor()): ?>
										<p class="f20 col">|</p>
										<a href="ouvidor.php" class="f20 bottom col pointer l2 fpreto">Manifestações Recebidas</a>
									<?php endif; ?>
								</div>
								<hr class="hr azule">
							</div>
							<div>
								<div class="row bottom">
									<form class="col col-12" action="php/selecionar.php" method="get">
										...
										<div class="col col-1">
											<button type="submit" name="x" value="mu" class="btn hover center col-12 azule fbranco upcase  rad-5">Filtrar</button>
										</div>
									</form>
								</div>
								<div class="row">
									<div class="col col-12 cinzac">
										<?php if(count($_SESSION['manifestos']) <= 0): ?>
										...
										<?php else: ?>
											...
											<ul class="show row col-12 scroll">
												<?php for ($y=(count($_SESSION['manifestos'])-1); $y >= 0 ; $y--) {
													if($_SESSION['manifestos'][$y]['relevancia'] == null){
														$_SESSION['manifestos'][$y]['relevancia'] = "---";
													} 
													echo "<li class='row col-12 li'>
															<a href='manifesto.php?id=".$_SESSION['manifestos'][$y]['id']."' class='l2 fpreto'>
																<div class='col col-4'>
																	<p>".$_SESSION['manifestos'][$y]['assunto']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$_SESSION['manifestos'][$y]['tipo']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$_SESSION['manifestos'][$y]['setor']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$_SESSION['manifestos'][$y]['relevancia']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$_SESSION['manifestos'][$y]['status']."</p>
																</div>
															</a>
														</li>";
												} ?>
