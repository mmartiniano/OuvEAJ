...
<body>
	<?php if(logado()): ?>
		<?php if(!selecionado()){
		 	header("location: php/selecionar.php?x=ma&tipo=null&setor=null&relevancia=null&status=null");
		} ?>
		<div class="all col-12 azuloc consolas f18">
			...
			<div>
				<section class="row">
					<section class="container-main row col col-12">
						...
						<div class="container main col-9 col row branco rad-1">
							<div>
								<div class="row col-12 col">
									<h2 class="f20 bottom">Explorar Manifestações</h2>
								</div>
								<hr class="hr azule">
							</div>
							<div>
								<div class="row bottom">
									<form class="col col-12" action="php/selecionar.php?x=ma" method="get">
										...
										<div class="col col-1">
											<button type="submit" name="x" value="ma" class="btn hover center col-12 azule fbranco upcase  rad-5">Filtrar</button>
										</div>
									</form>
								</div>
								<div class="row">
									<div class="col col-12 cinzac">
										<?php if(count($_SESSION['manifestosall']) <= 0): ?>
										...
										<?php else: ?>
											...
											<ul class="show row col-12 scroll">
												<?php for ($y=(count($_SESSION['manifestosall'])-1); $y >= 0 ; $y--) {
													if($_SESSION['manifestosall'][$y]['relevancia'] == null){
														$_SESSION['manifestosall'][$y]['relevancia'] = "---";
													} 
													echo "<li class='row col-12 li'>
															<a href='manifesto.php?id=".$_SESSION['manifestosall'][$y]['id']."' class='l2 fpreto'>
																<div class='col col-4'>
																	<p>".$_SESSION['manifestosall'][$y]['assunto']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$_SESSION['manifestosall'][$y]['tipo']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$_SESSION['manifestosall'][$y]['setor']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$_SESSION['manifestosall'][$y]['relevancia']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$_SESSION['manifestosall'][$y]['status']."</p>
																</div>
															</a>
														</li>";
												} ?>
