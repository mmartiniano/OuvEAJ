<?php
	...
	for ($y=0; $y < count($_SESSION['feedbacks']); $y++) { 
		if ($id == $_SESSION['feedbacks'][$y]['id']) {
			$feedback = $_SESSION['feedbacks'][$y];
		}
	}
?>
						...
						<div class="container main col-9 col row branco rad-1">
							<div class="grups">
								<div class="row col-12 col">
									<h2 class="f20 bottom">Analisar Feedback</h2>
								</div>
								<hr class="hr azule">
							</div>
							<div>
								<div class="row col-12">	
									<div class="row col col-5">
										<div class="col col-12 row grups">
											<p class="bottom">E-mail: <strong><?php echo $feedback['email']; ?></strong></p>
											<hr>
										</div>			
									</div>										
									<div class="row col col-7">
										<div class="col col-12 grups">
											<textarea class="inp col col-12 text-area" type="text" name="corpo" disabled><?php echo $feedback['feedback']; ?></textarea>
										</div>
									</div>
								</div>
							</div>
