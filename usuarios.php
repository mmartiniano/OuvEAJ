...
<body>
	<?php if(logado() and administrador()): ?>
		<?php if(!selecionado()){
	 		header("location: php/selecionar.php?x=us&cargo=null&setor=null");
		}
		?>
						...
						<div class="container main col-9 col row branco rad-1">
							<div>
								<div class="row col-12 col">
									<h2 class="f20 bottom">Gerir Usuários</h2>
								</div>
								<hr class="hr azule">
							</div>
							<div>
								<div class="row bottom">
									<form class="col col-12" action="php/selecionar.php" method="get">
										<div class="col col-3 row">
											<p class="col col-4">Cargo</p>
											<select class="select col-8 col" name="cargo">
												<option value=null>-----</option>
												<option  <?php if((isset($_SESSION['fcargo']) and ($_SESSION['fcargo'] == 1))) {echo "selected";}?> value="1">Manifestante</option>
												<option  <?php if((isset($_SESSION['fcargo']) and ($_SESSION['fcargo'] == 2))) {echo "selected";}?> value="2">Ouvidor</option>
												<option  <?php if((isset($_SESSION['fcargo']) and ($_SESSION['fcargo'] == 3))) {echo "selected";}?> value="3">Admnistrador</option>
											</select>
										</div>
										<div class="col col-3 row">
											...
											<select class="select col-8 col" name="setor">
												<option value=null>-----</option>
												<option <?php if((isset($_SESSION['fsetor']) and ($_SESSION['fsetor'] == 1))) {echo "selected";}?> value="1">Agroindústria</option>
												<option <?php if((isset($_SESSION['fsetor']) and ($_SESSION['fsetor'] == 2))) {echo "selected";}?> value="2">Agropecuária</option>
												<option <?php if((isset($_SESSION['fsetor']) and ($_SESSION['fsetor'] == 3))) {echo "selected";}?> value="3">Aquicultura</option>
												<option <?php if((isset($_SESSION['fsetor']) and ($_SESSION['fsetor'] == 4))) {echo "selected";}?> value="4">Ensino Médio</option>
												<option <?php if((isset($_SESSION['fsetor']) and ($_SESSION['fsetor'] == 5))) {echo "selected";}?> value="5">Graduação</option>
												<option <?php if((isset($_SESSION['fsetor']) and ($_SESSION['fsetor'] == 6))) {echo "selected";}?> value="6">Informática</option>
												<option <?php if((isset($_SESSION['fsetor']) and ($_SESSION['fsetor'] == 7))) {echo "selected";}?> value="7">Internato</option>
											</select>
										</div>
										<div class="col col-1">
											<button type="submit" name="x" value="us" class="btn hover center col-12 azule fbranco upcase  rad-5">Filtrar</button>
										</div>
									</form>
								</div>
								<div class="row">
									<div class="col col-12 cinzac">
										<?php if(count($_SESSION['usuarios']) <= 0): ?>
											<div class="f20 center col col-12 show">
												<p class="top">Nenhum usuário registrado</p>
											</div>
										<?php else: ?>
											...
											<ul class="show row col-12 scroll">
												<?php for ($y=(count($_SESSION['usuarios'])-1); $y >= 0 ; $y--) {
													...
													echo "<li class='row col-12 li'>
															<a href='usuario.php?id=".$_SESSION['usuarios'][$y]['id']."' class='l2 fpreto'>
																<div class='col col-6'>
																	<p>".$_SESSION['usuarios'][$y]['nome']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$_SESSION['usuarios'][$y]['matricula']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$_SESSION['usuarios'][$y]['setor']."</p>
																</div>
																<div class='col col-2'>
																	<p>".$cargo."</p>
																</div>
